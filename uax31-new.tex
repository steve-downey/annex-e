...
\begin{removedblock}
\rSec2[uaxid.def.rfmt]{\added{UAX31-}R1a Restricted format characters}
...
\rSec1[uaxid.immutable]{\added{UAX31-}R2 Immutable identifiers}
...
\rSec1[uaxid.pattern]{\added{UAX31-}R3 Pattern_White_Space and Pattern_Syntax characters}
...
\rSec1[uaxid.eqn]{\added{UAX31-}R4 Equivalent normalized identifiers}
...
\rSec1[uaxid.eqci]{\added{UAX31-}R5 Equivalent case-insensitive identifiers}
...
\rSec1[uaxid.filter]{\added{UAX31-}R6 Filtered normalized identifiers}
...
\rSec1[uaxid.filterci]{\added{UAX31-}R7 Filtered case-insensitive identifiers}

\pnum
\Cpp{} identifiers are case sensitive, and
therefore this requirement from \UAX{31} does not apply.

\rSec1[uaxid.hashtag]{\added{UAX31-}R8 Hashtag identifiers}
